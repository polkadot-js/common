...
▸ **compactStripLength**(input: *`Uint8Array`*, bitLength?: *`BitLength`*): [`number`, `Uint8Array`]

*Defined in [compact/stripLength.ts:22](https://github.com/polkadot-js/common/blob/e5cab29/packages/util/src/compact/stripLength.ts#L22)*
