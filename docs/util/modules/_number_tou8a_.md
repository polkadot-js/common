[@polkadot/util](../README.md) > ["number/toU8a"](../modules/_number_tou8a_.md)
...
*Defined in [number/toU8a.ts:19](https://github.com/polkadot-js/util/blob/7550b44/packages/util/src/number/toU8a.ts#L19)*
