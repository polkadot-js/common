...
*Defined in [logger.ts:42](https://github.com/polkadot-js/common/blob/7b9ca4a/packages/util/src/logger.ts#L42)*
...
*Defined in [logger.ts:105](https://github.com/polkadot-js/common/blob/7b9ca4a/packages/util/src/logger.ts#L105)*
