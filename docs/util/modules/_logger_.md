...
*Defined in [logger.ts:36](https://github.com/polkadot-js/common/blob/40f3ceb/packages/util/src/logger.ts#L36)*
...
*Defined in [logger.ts:105](https://github.com/polkadot-js/common/blob/40f3ceb/packages/util/src/logger.ts#L105)*
