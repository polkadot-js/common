...
*Defined in [logger.ts:42](https://github.com/polkadot-js/common/blob/2aba82e/packages/util/src/logger.ts#L42)*
...
*Defined in [logger.ts:105](https://github.com/polkadot-js/common/blob/2aba82e/packages/util/src/logger.ts#L105)*
