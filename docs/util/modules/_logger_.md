...
*Defined in [logger.ts:36](https://github.com/polkadot-js/common/blob/2be211c/packages/util/src/logger.ts#L36)*
...
*Defined in [logger.ts:109](https://github.com/polkadot-js/common/blob/2be211c/packages/util/src/logger.ts#L109)*
