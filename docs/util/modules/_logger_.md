...
*Defined in [logger.ts:36](https://github.com/polkadot-js/common/blob/e5cab29/packages/util/src/logger.ts#L36)*
...
*Defined in [logger.ts:109](https://github.com/polkadot-js/common/blob/e5cab29/packages/util/src/logger.ts#L109)*
