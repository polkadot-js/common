...
*Defined in [logger.ts:42](https://github.com/polkadot-js/common/blob/49b0c84/packages/util/src/logger.ts#L42)*
...
*Defined in [logger.ts:104](https://github.com/polkadot-js/common/blob/49b0c84/packages/util/src/logger.ts#L104)*
