...
*Defined in [logger.ts:42](https://github.com/polkadot-js/common/blob/c3fafbe/packages/util/src/logger.ts#L42)*
...
*Defined in [logger.ts:104](https://github.com/polkadot-js/common/blob/c3fafbe/packages/util/src/logger.ts#L104)*
