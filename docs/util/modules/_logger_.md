...
*Defined in [logger.ts:42](https://github.com/polkadot-js/common/blob/9f9ceff/packages/util/src/logger.ts#L42)*
...
*Defined in [logger.ts:104](https://github.com/polkadot-js/common/blob/9f9ceff/packages/util/src/logger.ts#L104)*
