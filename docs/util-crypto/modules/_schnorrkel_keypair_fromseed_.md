...
*Defined in [schnorrkel/keypair/fromSeed.ts:16](https://github.com/polkadot-js/common/blob/c3fafbe/packages/util-crypto/src/schnorrkel/keypair/fromSeed.ts#L16)*
