...
- **Breaking change** Following on the 2.0 release, `@polkadot/wasm` was updated to 1.1.1. sr25510 now only verifies 0.8+ signatures, closing the loop on no Substrate-era 1.x support
