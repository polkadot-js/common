...
[![dependency](https://david-dm.org/polkadot-js/client.svg?style=flat-square&path=packages/keyring)](https://david-dm.org/polkadot-js/client?path=packages/keyring)
[![devDependency](https://david-dm.org/polkadot-js/client/dev-status.svg?style=flat-square&path=packages/keyring)](https://david-dm.org/polkadot-js/client?path=packages/keyring#info=devDependencies)
