...
const data: { [index: string]: TestData } = {
  ...
  substrate0: {
    ...
    output: Uint8Array.from([
      254, 140, 0, 104, 32, 7, 179, 135, 45, 71, 24, 27, 74, 45, 193, 95, 13, 164, 62, 112, 38, 32, 232, 3, 0, 0, 0, 0, 0, 0, 128, 23, 13, 50, 42, 196, 157, 135, 8, 241, 81, 52, 108, 104, 217, 229, 132, 82, 216, 58, 157, 59, 113, 14, 30, 173, 53, 235, 50, 105, 171, 35, 83, 104, 32, 9, 53, 228, 111, 148, 242, 75, 130, 113, 108, 1, 66, 226, 39, 29, 233, 32, 0, 135, 0, 0, 0, 0, 0, 0
    ]),
    root: Uint8Array.from([
      209, 215, 192, 32, 117, 98, 175, 236, 219, 126, 140, 249, 69, 164, 2, 177, 157, 55, 140, 179, 55, 161, 5, 53, 177, 196, 36, 20, 84, 190, 158, 33
    ])
  }
};
