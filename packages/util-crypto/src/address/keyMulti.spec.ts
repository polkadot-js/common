...
import createKeyMulti, { sortU8a } from './keyMulti';

describe('sortU8a', (): void => {
  it('sorts a simple set of u8a', (): void => {
    expect(
      sortU8a([new Uint8Array([1, 2, 3]), new Uint8Array([4, 5, 6]), new Uint8Array([2, 3, 4])])
  ...
  it('sorts a simple set of u8a (not the same lengths)', (): void => {
    expect(
      sortU8a([new Uint8Array([1, 2, 3, 4]), new Uint8Array([4, 5, 6]), new Uint8Array([1, 2, 3, 5])])
